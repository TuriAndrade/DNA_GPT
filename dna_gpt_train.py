...
if __name__ == "__main__":
    trainer_config = DNAGPTTrainerConfig(
        model_config=GPTConfig.gpt_mini(
            vocab_size=6,
            block_size=512,
        ),
        optim_config=GPTOptimConfig(),
        load_seq_data_config=LoadSeqDataConfig(
            file_path="/home/turi/aulas/8sem/bioinfo/DNA_GPT/data/dna_seq_human.txt",
    ...
    trainer.single_gpu_train(device="cuda")
